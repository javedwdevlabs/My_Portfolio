  ...
  const projects = [
    {
      ...
      description:
        "An exploratory data analysis project focused on understanding Uber trip patterns, customer behavior, peak hours, booking categories, and operational insights.",
      technologies: ["Python", "Pandas", "NumPy", "Seaborn", "Matplotlib"],
      type: "EDA & Feature Engineering",
      path: "/uber-eda",
    }
  ];
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-2xl text-[var(--color-text-secondary)]">
            Explore my data analysis projects where I work with real-world
            datasets to find patterns, trends, and useful insights.
          </p>
        </motion.div>
